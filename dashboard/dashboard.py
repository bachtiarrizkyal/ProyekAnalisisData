...
# Load data csv
all_df = pd.read_csv("https://raw.githubusercontent.com/bachtiarrizkyal/ProyekAnalisisData/main/data/all_data.csv")
...
with st.sidebar:
    st.markdown(
        ...
        <div style='display: flex; align-items: center; justify-content: center;'>
            <img src='https://i.pinimg.com/236x/04/19/25/0419256d054e2bd00229102072fd898a.jpg' alt='Logo' style='width: 80px; height: 80px;'>
            <div style='margin-left: 10px; font-size: 24px; font-weight: bold; color: #4A3AFF;'>Bachtiar E-Commerce Public Projects</div>
        </div>
        """,
    ...
    st.markdown(
        ...
        - Email: [bachtiarrizkyalamsyah17@gmail.com](mailto:bachtiarrizkyalamsyah17@gmail.com)
        - Linkedin: [Bachtiar Rizky Alamsyah](https://www.linkedin.com/in/bachtiarrizkyalamsyah/)
        """,
        unsafe_allow_html=True
    )
    st.markdown("<hr style='margin: 15px 0; border-color: #4A3AFF;'>", unsafe_allow_html=True)
    
    st.caption('Copyright (C) Bachtiar Rizky Alamsyah. 2024')
...
data = {'review_score': np.random.randint(1, 6, size=100)}
